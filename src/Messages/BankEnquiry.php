...
class BankEnquiry extends Message implements Contract {
	...
	public function __construct() {
		...
		$this->url = App::environment('production') ?
			Config::get('sbi-pay.urls.production.bank_enquiry') :
			Config::get('sbi-pay.urls.uat.bank_enquiry');
	}
	...
	public function getData() {
		return collect([
			...
			'fpx_sellerExId' => urlencode($this->merchantId),
	...
	/**
	 * connect and excute the request to SBI server
	 *
	 */
